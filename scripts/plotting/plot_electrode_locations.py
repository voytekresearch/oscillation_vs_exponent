...
def main():
    ...
    # Plot each hemispheres and view and save to file
    for hemisphere in ['right', 'left']:
        for view in ['lateral', 'medial']:
            print(f"Plotting {hemisphere} hemisphere, {view} view")
            _plot_electrodes(elec_info, hemisphere, view, dir_fig)
...
def _plot_electrodes(elec_info, hemisphere, view, dir_fig):
